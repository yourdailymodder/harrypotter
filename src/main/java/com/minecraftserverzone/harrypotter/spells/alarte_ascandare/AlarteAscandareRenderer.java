...
public class AlarteAscandareRenderer extends EntityRenderer<AlarteAscandare> {
   ...
   private final ExpelliarmusModel<AlarteAscandare> model;
   
   public AlarteAscandareRenderer(EntityRendererProvider.Context p_174296_) {
      super(p_174296_);
      this.model = new ExpelliarmusModel<>(p_174296_.bakeLayer(ExpelliarmusModel.LAYER_LOCATION));
   }
   
  @Override
	protected int getBlockLightLevel(AlarteAscandare p_114496_, BlockPos p_114497_) {
		return 15;
	}

   public void render(AlarteAscandare p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_, MultiBufferSource p_115377_, int p_115378_) {
      p_115376_.pushPose();
   ...
   public ResourceLocation getTextureLocation(AlarteAscandare p_115371_) {
      return LOCATION;
   }
}