...
public class FumosRenderer extends EntityRenderer<Fumos> {
   ...
   public FumosRenderer(EntityRendererProvider.Context p_173962_) {
      super(p_173962_);
   }

   @Override
	protected int getBlockLightLevel(Fumos p_114496_, BlockPos p_114497_) {
		return 15;
	}

   @Override
   public void render(Fumos p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
      p_114083_.pushPose();
...
//      p_114083_.scale(scale1, scale1, scale1);
   ...
   @Override
   public ResourceLocation getTextureLocation(Fumos p_114078_) {
