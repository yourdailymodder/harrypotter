...
public class ConfringoRenderer extends EntityRenderer<Confringo> {
   private static final ResourceLocation LOCATION = new ResourceLocation(HarryPotterMod.MODID, "textures/entity/confringo.png");
   private final ConfringoModel<Confringo> model;
   
   public ConfringoRenderer(EntityRendererProvider.Context p_174296_) {
      super(p_174296_);
      this.model = new ConfringoModel<>(p_174296_.bakeLayer(ConfringoModel.LAYER_LOCATION));
   }
   
  @Override
	protected int getBlockLightLevel(Confringo p_114496_, BlockPos p_114497_) {
		return 15;
	}

   public void render(Confringo p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_, MultiBufferSource p_115377_, int p_115378_) {
      p_115376_.pushPose();
   ...
   public ResourceLocation getTextureLocation(Confringo p_115371_) {
      return LOCATION;
   }
}