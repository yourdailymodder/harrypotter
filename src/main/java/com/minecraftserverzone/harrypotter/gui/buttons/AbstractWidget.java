...
public abstract class AbstractWidget extends GuiComponent implements Renderable, GuiEventListener, NarratableEntry {
   ...
   public AbstractWidget(int p_93629_, int p_93630_, int p_93631_, int p_93632_, Component p_93633_, boolean enoughexp) {
      this.x = p_93629_;
      this.y = p_93630_;
      this.width = p_93631_;
   ...
   public void renderButton(PoseStack p_93676_, int p_93677_, int p_93678_, float p_93679_) {
      ...
      this.blit(p_93676_, this.x, this.y+ (this.height/2), 0, 61 + i * 20, this.width / 2, this.height/2);
      this.blit(p_93676_, this.x + this.width / 2, this.y + (this.height/2), 200 - this.width / 2, 61 + i * 20, this.width / 2, this.height/2);
