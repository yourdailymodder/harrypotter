...
//     */
//    public static ConfiguredStructureFeature<?, ?> CONFIGURED_THIEFDEN = Registrations.WITCH_TOWER.get()
...
//        Registry.register(BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, new ResourceLocation(HarryPotterMod.MODID, "thiefden"),
//            CONFIGURED_THIEFDEN);
//    }
//    
//    
...
////        if (event.getStructure() == Registrations.PORTAL_OVERWORLD.get() || event.getStructure() == Registrations.PORTAL_MYSTERIOUS.get()) {
