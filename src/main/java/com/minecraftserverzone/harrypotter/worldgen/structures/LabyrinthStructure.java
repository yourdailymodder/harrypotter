...
public class LabyrinthStructure extends Structure {
    ...
    public static final Codec<LabyrinthStructure> CODEC = RecordCodecBuilder.<LabyrinthStructure>mapCodec(instance ->
            instance.group(LabyrinthStructure.settingsCodec(instance),
            ...
            ).apply(instance, LabyrinthStructure::new)).codec();
    ...
    public LabyrinthStructure(Structure.StructureSettings config,
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!LabyrinthStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return Registrations.LABYRINTH.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}